...
const propamitAPI = {
  ...
  login: async (credentials) => {
    try {
      const response = await fetch(`${propamitAPI.baseURL}/auth/login`, {
        method: 'POST',
        headers: {
  ...
  register: async (userData) => {
    try {
      const response = await fetch(`${propamitAPI.baseURL}/auth/register`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json'
  ...
  forgotPassword: async (email) => {
    try {
      const response = await fetch(`${propamitAPI.baseURL}/auth/forgot-password`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json'
